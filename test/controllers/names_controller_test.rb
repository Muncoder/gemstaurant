...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { email: @name.email, table_id: @name.table_id } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { email: @name.email, table_id: @name.table_id } }, as: :json
    assert_response 200
  end
